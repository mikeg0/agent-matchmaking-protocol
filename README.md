...
| Go | `go/` | ✅ Baseline client + models complete |
| Rust | `rust/` | ✅ Baseline client + models complete *(local compile pending toolchain)* |
| Java | `java/` | ✅ Baseline client + models complete *(local compile pending toolchain)* |
